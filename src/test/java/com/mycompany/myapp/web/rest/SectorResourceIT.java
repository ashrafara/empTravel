...
class SectorResourceIT {
    ...
    public static Sector createEntity(EntityManager em) {
        Sector sector = new Sector().name(DEFAULT_NAME).phone(DEFAULT_PHONE).address(DEFAULT_ADDRESS);
        return sector;
    }
    ...
    public static Sector createUpdatedEntity(EntityManager em) {
        Sector sector = new Sector().name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
        return sector;
    }
    ...
    void createSector() throws Exception {
        ...
        assertThat(testSector.getPhone()).isEqualTo(DEFAULT_PHONE);
        assertThat(testSector.getAddress()).isEqualTo(DEFAULT_ADDRESS);
    }
    ...
    void putNewSector() throws Exception {
        ...
        updatedSector.name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
        ...
        assertThat(testSector.getPhone()).isEqualTo(UPDATED_PHONE);
        assertThat(testSector.getAddress()).isEqualTo(UPDATED_ADDRESS);
    }
    ...
    void partialUpdateSectorWithPatch() throws Exception {
        ...
        partialUpdatedSector.name(UPDATED_NAME).phone(UPDATED_PHONE).address(UPDATED_ADDRESS);
