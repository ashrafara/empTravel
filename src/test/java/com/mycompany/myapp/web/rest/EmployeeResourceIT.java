...
class EmployeeResourceIT {
    ...
    private static final String DEFAULT_JOBPOSITION = "AAAAAAAAAA";
    private static final String UPDATED_JOBPOSITION = "BBBBBBBBBB";
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee()
            .name(DEFAULT_NAME)
            .jobposition(DEFAULT_JOBPOSITION)
            .phone(DEFAULT_PHONE)
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee()
            .name(UPDATED_NAME)
            .jobposition(UPDATED_JOBPOSITION)
            .phone(UPDATED_PHONE)
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getJobposition()).isEqualTo(DEFAULT_JOBPOSITION);
        assertThat(testEmployee.getPhone()).isEqualTo(DEFAULT_PHONE);
        assertThat(testEmployee.getDepartement()).isEqualTo(DEFAULT_DEPARTEMENT);
    }
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.[*].jobposition").value(hasItem(DEFAULT_JOBPOSITION)))
    ...
    void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc
            ...
            .andExpect(jsonPath("$.jobposition").value(DEFAULT_JOBPOSITION))
    ...
    void putNewEmployee() throws Exception {
        ...
        updatedEmployee.name(UPDATED_NAME).jobposition(UPDATED_JOBPOSITION).phone(UPDATED_PHONE).departement(UPDATED_DEPARTEMENT);
        ...
        assertThat(testEmployee.getJobposition()).isEqualTo(UPDATED_JOBPOSITION);
        assertThat(testEmployee.getPhone()).isEqualTo(UPDATED_PHONE);
        assertThat(testEmployee.getDepartement()).isEqualTo(UPDATED_DEPARTEMENT);
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.jobposition(UPDATED_JOBPOSITION).phone(UPDATED_PHONE);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.name(UPDATED_NAME).jobposition(UPDATED_JOBPOSITION).phone(UPDATED_PHONE).departement(UPDATED_DEPARTEMENT);
