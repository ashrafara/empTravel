...
describe('Decree Management Component', () => {
  let comp: DecreeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DecreeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.decrees?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
