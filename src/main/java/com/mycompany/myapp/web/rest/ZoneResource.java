    ...
    public ResponseEntity<Zone> partialUpdateZone(@PathVariable(value = "id", required = false) final Long id, @RequestBody Zone zone)
        ...
        Optional<Zone> result = zoneRepository
            ...
            .map(existingZone -> {
                ...
                if (zone.getAmount1() != null) {
                    existingZone.setAmount1(zone.getAmount1());
                }
                if (zone.getAmount2() != null) {
                    existingZone.setAmount2(zone.getAmount2());
                }
                if (zone.getAmount3() != null) {
                    existingZone.setAmount3(zone.getAmount3());
                }
